...
public abstract class AlgoritmoPlanificacion {
    ...
    public void imprimir() {
        ...
        for (int i = 0; i < lista_imprimir.size(); i++) {
            process.add(lista_imprimir.get(i));
        }
        menuSchedulerView.initializeTableValues(process);
        menuSchedulerView.updateTable(lista_imprimir, Promedio(SumaTotal), Promedio(SumaTotal_Espera));
